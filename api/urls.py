...
from api.views.views import  getEntry, getNovel, getNovelsAndChapters, EditEntryView, CleanEditEntryView, AnnotationView, BlacklistEntryView, ReloadCEDictView, ClearRAMView
...
urlpatterns = [
    ...
    path('clearram', ClearRAMView.as_view()),
